...
[DanielJS Recording](https://generalassembly.zoom.us/rec/share/xuJ8Er_CzjxOQtbLuXn-RogoH7jUT6a82nQer_NZmh4ZcOO_YhxFDRZJXTmhFpFY?startTime=1598729762000)
...
<a href="/downloads/second_language/realtime-with-socket-io/starter-code/realtime-circles.zip" download>Click here</a> to download the starter code:
...
### 💪 Exercise - Clear All Circles Practice (10 mins)

- Let's get everyone into a breakout room and make the `clear` button clear all connected user's displays instead of just yours.
...
- <a href="/downloads/second_language/realtime-with-socket-io/completed-code/realtime-circles.zip" download>Completed Version of Realtime Circles **(Download)**</a>
